...
public class PlayerInputController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        controls.Player.Block.started += ctx =>    Block = true;
        controls.Player.Block.performed += ctx =>  Block = false;
    }
    ...
    {
        //Dpad mapping from square to circular as demonstrated in Milestone 1
